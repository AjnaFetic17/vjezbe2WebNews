        ...
        <table style="width:100%; border: 1px solid black;">
            ...
            <c:forEach items="${news}" var="n">
                <tr style="border: 1px solid black;">
                    ...
                    <c:if test="${user ==null}"><td style="border: 1px solid black;"> <a href="ShowCommentsGuest?action=${n.newsID}">Show comments</a></td>    </c:if>
                    <c:if test="${user.roleID !=null}"><td style="border: 1px solid black;"> <a href="ShowComments?action=${n.newsID}">Show comments</a></td>    </c:if>
