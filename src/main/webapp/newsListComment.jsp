<%-- 
    Document   : newsListComment
    Created on : Oct 31, 2022, 7:30:22 PM
    Author     : Blandus
--%>
        ...
        <table style="width:100%; border: 1px solid black;">
            ...
            <c:forEach items="${news}" var="n">
                <tr style="border: 1px solid black;">
                   ...
                   <td style="border: 1px solid black;"> <a href="ShowCommentsList?action=${n.newsID}">Show comments for this news</a></td>
